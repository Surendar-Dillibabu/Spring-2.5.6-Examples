...
/**
 * This auto wiring happens based on the class type. So, if we have any name if
...
public class AutowireByTypeEx {
  ...
  public static void main(String[] args) {
    ...
    ApplicationContext appContext = new ClassPathXmlApplicationContext("xml/applicationContextByType.xml");
